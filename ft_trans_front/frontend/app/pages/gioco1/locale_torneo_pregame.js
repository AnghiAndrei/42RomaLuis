...
class Torneo {
  constructor() {
    localStorage.setItem('tp1', localStorage.getItem('p1'));
    this.numPlayers = parseInt(localStorage.getItem("tornplayerg1"));
    this.gruppo1 = [];
    this.gruppo2 = [];
    this.gruppo3 = [];
    this.winner = [];
  ...
  update(){
    ...
    .then((module) => {
      ...
      if(this.turno==1){
        localStorage.setItem('p1', this.gruppo1[0].name);
        localStorage.setItem('p2', this.gruppo1[1].name);
      }
      ...
      if(this.turno==2){
        localStorage.setItem('p1', this.gruppo2[0].name);
        localStorage.setItem('p2', this.gruppo2[1].name);
      }

      if(this.turno==3){
        localStorage.setItem('p1', this.gruppo3[0].name);
        localStorage.setItem('p2', this.gruppo3[1].name);
      }
