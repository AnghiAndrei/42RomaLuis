...
import { PaddleIA } from './_paddle_ia.js';
...
export function loadLocaleIaGame1Page() {
    ...
    .then((module) => {
        ...
        const rightPaddle = new PaddleIA(canvas.width - paddleWidth - 10, canvas.height / 2 - paddleHeight / 2, paddleWidth, paddleHeight, 'sg', ball);
        let upPaddle = null;
        let downPaddle = null;
        if(sessionStorage.getItem('nplayerg1')==3 || sessionStorage.getItem('nplayerg1')==4)
            upPaddle = new PaddleIA(canvas.width / 2 - paddleHeight / 2, 10, paddleHeight, paddleWidth, 'ds', ball);
        if(sessionStorage.getItem('nplayerg1')==4)
            downPaddle = new PaddleIA(canvas.width / 2 - paddleHeight / 2, canvas.height - 10 - paddleWidth, paddleHeight, paddleWidth, 'ds', ball);
