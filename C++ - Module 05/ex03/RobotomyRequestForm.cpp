...
RobotomyRequestForm::RobotomyRequestForm(std::string name2) : Form(), grades(72), gradee(45), name(name2){this->signedf=false;}
RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm &ncopy) : Form(), grades(ncopy.grades), gradee(ncopy.gradee), name(ncopy.name){this->signedf=ncopy.signedf;}
