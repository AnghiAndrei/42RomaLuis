...
PresidentialPardonForm::PresidentialPardonForm(std::string name2) : Form(), grades(25), gradee(5), name(name2){this->signedf=false;}
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm &ncopy) : Form(), grades(ncopy.grades), gradee(ncopy.gradee), name(ncopy.name){this->signedf=ncopy.signedf;}
